...
<div class="settings-section-wrap <?php echo ($isPro ? 'pro-section' : ''); ?>" id="<?php echo $id ?>">
    <div class="settings-section-heading">
        <div class="settings-section-heading-inner">
            <h3><?php echo $section['title'].($isPro ? '<span class="pro-notice">PRO</span>' : ''); ?></h3>
    ...
    <div class="settings-section-content">
        <?php foreach($fields as $fieldId=>$field):
            if($field['section'] === $id)
                \GDLightbox\Helpers\ViewLoader::render('admin/settings/field.view.php', compact('fieldId','field', 'section'));
        endforeach; ?>
    </div>
</div>
